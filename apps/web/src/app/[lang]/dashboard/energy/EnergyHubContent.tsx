...
interface EnergyHubContentProps {
    lang: string;
    initialProperties?: OwnerPropertySummary[];
}

export default function EnergyHubContent({ lang, initialProperties }: EnergyHubContentProps) {
    const router = useRouter();

    const [properties, setProperties] = useState<OwnerPropertySummary[]>(initialProperties || []);
