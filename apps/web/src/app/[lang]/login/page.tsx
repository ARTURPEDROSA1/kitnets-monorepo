            ...
            <div className="w-full max-w-md space-y-8">
                <div className="bg-card border border-border rounded-xl shadow-lg p-8">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-foreground">{dict.residentLogin.title}</h2>
                        <p className="mt-2 text-sm text-muted-foreground">
                            {dict.residentLogin.subtitle}
                        </p>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <Link href={lang === 'pt' ? '/signup' : `/${lang}/signup`} className="w-full">
                ...
                <div className="mt-12 text-foreground max-w-3xl mx-auto space-y-8">
                    <div className="text-center">
                        <h3 className="text-2xl font-bold mb-4">{dict.residentLogin.whyRegisterTitle}</h3>
                        {dict.residentLogin.intro?.map((paragraph: string, idx: number) => (
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        {dict.residentLogin.benefits?.map((section: any, idx: number) => (
                    ...
                    <div className="text-center bg-muted/30 p-8 rounded-xl border border-border mt-8">
                        <p className="text-lg font-medium text-foreground">
                            {dict.residentLogin.cta}
                        </p>
                        <div className="mt-6">
                            <Link href={lang === 'pt' ? '/signup' : `/${lang}/signup`}>
