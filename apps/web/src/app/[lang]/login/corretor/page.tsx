...
export default async function BrokerLoginPage({ params }: { params: Promise<{ lang: "en" | "pt" | "es" }> }) {
            ...
            <div className="w-full max-w-md space-y-8">
                <div className="bg-card border border-border rounded-xl shadow-lg p-8">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-foreground">{dict.brokerLogin.title}</h2>
                        <p className="mt-2 text-sm text-muted-foreground">
                            {dict.brokerLogin.subtitle}
                        </p>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <Link href={lang === 'pt' ? '/signup/corretor' : `/${lang}/signup/corretor`} className="w-full">
                ...
                <div className="mt-12 text-foreground max-w-3xl mx-auto space-y-8">
                    <div className="text-center">
                        <h3 className="text-2xl font-bold mb-4">{dict.brokerLogin.whyRegisterTitle}</h3>
                        {dict.brokerLogin.intro?.map((paragraph: string, idx: number) => (
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                        {dict.brokerLogin.benefits?.map((section: any, idx: number) => (
                    ...
                    <div className="text-center bg-muted/30 p-8 rounded-xl border border-border mt-8">
                        <p className="text-lg font-medium text-foreground">
                            {dict.brokerLogin.cta}
                        </p>
                        <div className="mt-6">
                            <Link href={lang === 'pt' ? '/signup/corretor' : `/${lang}/signup/corretor`}>
