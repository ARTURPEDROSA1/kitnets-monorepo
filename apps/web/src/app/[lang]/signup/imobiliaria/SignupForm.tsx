...
export default function SignupForm({ lang }: { lang: "en" | "pt" | "es" }) {
    ...
    const dict = {
        title: "Crie sua conta de Imobiliária",
        subtitle: "Gestão completa para sua imobiliária.",
            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="mt-8 bg-card py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-border">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <a href={`/${lang}/login/imobiliaria`} className="flex w-full justify-center rounded-md border border-border bg-background py-2 px-4 text-sm font-medium text-foreground shadow-sm hover:bg-muted/50">
                                {dict.login}
                            </a>
                        </div>
                    </div>
