            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    <div className="h-48 bg-muted w-full relative group-hover:opacity-90 transition-opacity">
                        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-green-500/5 to-green-500/10">
                            <span className="text-4xl font-bold text-green-500/20">CDB & IR</span>
                        </div>
                    </div>
                    <div className="p-6 flex flex-col flex-1">
                        <div className="mb-2 text-xs font-medium text-primary uppercase tracking-wider">
                            {lang === 'pt' ? 'Renda Fixa' : 'Fixed Income'}
                        </div>
                        <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors line-clamp-2">
                            Como fica a renda fixa com a reforma do Imposto de Renda
                        </h3>
                        <p className="text-muted-foreground text-sm line-clamp-3 mb-4 flex-1">
                            A tributação do CDB e Tesouro não muda, mas o contexto sim. Entenda o impacto do imposto mínimo para altas rendas.
                        </p>
