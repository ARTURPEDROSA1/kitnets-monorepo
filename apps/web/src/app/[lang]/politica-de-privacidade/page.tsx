...
export default async function PrivacyPage({ params }: { params: Promise<{ lang: "en" | "pt" | "es" }> }) {
    const { lang } = await params;
    const content = privacyContent[lang as keyof typeof privacyContent] || privacyContent.pt;
