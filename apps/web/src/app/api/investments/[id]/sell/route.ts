...
/**
 * POST /api/investments/[id]/sell  { sold_on, sale_price, sale_costs? }
 *
...
export const POST = withAuth<typeof sellInputSchema, Params>(
    ...
    async ({ body, params, profileId, supabase }) => {
        ...
        const { error } = await supabase
            ...
            .update({ status: "SOLD", sold_on: body.sold_on, sale_price: body.sale_price, sale_costs: body.sale_costs })
            .eq("id", params.id)
