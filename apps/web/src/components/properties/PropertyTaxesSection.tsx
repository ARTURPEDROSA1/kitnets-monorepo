...
const BOX = "bg-transparent border border-transparent hover:border-border focus:border-emerald-500 focus:bg-background rounded-none w-full min-w-[5rem] px-1.5 py-1 outline-none";
...
export default function PropertyTaxesSection({ propertyId, onRowsChange, preloadedRows }: Props) {
    ...
    const cf = useColumnFilters(inPeriodRows, TAX_COLUMNS, { key: "year", dir: "desc" }, { storageKey: columnTableKey("property-taxes") });
