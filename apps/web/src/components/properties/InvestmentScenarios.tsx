            ...
            {open && (
                <div className="px-4 pb-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                        <Tile label="Payback no cenário" tone="violet" icon={<FlaskConical className="w-4 h-4" />}
                        ...
                        <Tile label={financed ? "Financiamento" : "Renda até a venda"} tone="blue" icon={<FlaskConical className="w-4 h-4" />}
                            value={financed
                        ...
                        <Tile label="Venda" tone="emerald" icon={<FlaskConical className="w-4 h-4" />}
                        ...
                        <Tile label="TIR com venda" tone={result.irrAtSale !== null && result.irrAtSale >= 0 ? "emerald" : "slate"} icon={<FlaskConical className="w-4 h-4" />}
