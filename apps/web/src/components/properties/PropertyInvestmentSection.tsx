        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-xs space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <span className="text-xs text-muted-foreground">
                    Lançamentos · <span className="font-semibold text-foreground">{periodLabel(period)}</span> · {filtered.length} {filtered.length === 1 ? "lançamento" : "lançamentos"} · total {formatBRL(filteredTotal)}
            ...
            {loading ? (
                ...
                <div className="text-sm text-muted-foreground text-center py-8 border border-dashed border-border rounded-xl">Nenhum lançamento no período selecionado.</div>
            ) : (
                    ...
                    <table className="w-full text-xs min-w-[980px]">
                        <thead>
                            <tr className="text-[10px] uppercase tracking-wider text-muted-foreground border-b border-border">
                                ...
                                <th className="text-right px-2 py-2 font-semibold">Juros</th>
                                <th className="text-right px-2 py-2 font-semibold">Amortização</th>
                                <th className="text-right px-2 py-2 font-semibold">Seguro</th>
