...
CREATE TABLE IF NOT EXISTS public.properties (
    ...
    state TEXT,
    zip TEXT,
    connection_code TEXT,       -- SAAE "Cod. ligação"
    cadastral_map TEXT,         -- SAAE "Mapa cadastral"
    electronic_id TEXT,         -- SAAE "Id. eletrônico"
...
CREATE TABLE IF NOT EXISTS public.water_bills (
    ...
    consumption_m3 NUMERIC NOT NULL,       -- CONS. REAL (m³)
    billed_consumption_m3 NUMERIC,         -- CONS. FATURADO (m³)
    ...
    water_tariff NUMERIC DEFAULT 0,        -- TARIFA DE ÁGUA
    ...
    average_consumption_m3 NUMERIC,        -- MÉDIA from bill
...
-- (Replace owner_id with actual profile UUID if known)
...
-- Source: SAAE Itabirito — Hidrômetro Y21SG1602635
-- ============================================================
